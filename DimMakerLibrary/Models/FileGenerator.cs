...
namespace DimMakerLibrary.Models
{
    public static class FileGenerator
    {
        ...
        public static void GenerateViewAttributes()
        {
            ...
            WriteFile(Properties.Resources.REINF_FRONT,config.ReinfFrontViewAttrName);
            WriteFile(Properties.Resources.REINF_VERT_SPEC, config.ReinfSectionVerticalAttrName);
        }
